...
# 1d78:0000 : 48 bytes
data = b'\xe0\xff\xed\xff\x78\x00\x28\x00\x88\xff\xed\xff\x20\x00\x28\x00\xe0\xff\xed\xff\x4c\x00\x3d\x00\x88\xff\x02\x00\x78\x00\x32\x00\xb4\xff\xed\xff\x20\x00\x3d\x00\x88\xff\xf7\xff\x78\x00\x28\x00'

with CPPWriter('chunk_bounding_boxes.cpp') as w:
    w.writeln('#include "chunk_bounding_boxes.h"')
    w.writeln()
    w.writeln('#include <game/types/rectangle.h>')
    w.writeln()
